      ...
      <div className="max-w-6xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
        <div className="p-8">
          ...
          <div className='flex justify-center'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ml-auto ">
              ...
              {<div className="col-span-2 pb-10">
                ...
                {!data?.data?.vaccines.length && <span className='ml-2'>None</span>}
          ...
          <div className='flex justify-end'>
            ...
            <Button isDisabled={!data?.data?.vaccines.length} className='float-right mb-8 mr-2' colorScheme={'blue'} onClick={handleDownload}>
